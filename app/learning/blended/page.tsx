...
export const metadata: Metadata = {
  title: 'Blended Cohort Experience',
  description: 'Combining digital weekly seminars with monthly executive physical intensives at Zoe Elpis Global School.'
};
      ...
      <main id="main-content" className="flex-1 pb-24">
        <div className="bg-[var(--color-paper-100)] border-b border-[var(--color-paper-200)]">
          <div className="max-w-[1320px] mx-auto px-4 sm:px-8">
            <Breadcrumbs items={[{ label: 'Learning', href: '/learning' }, { label: 'Blended Cohorts' }]} />
          </div>
        </div>
          ...
          <div className="max-w-[1320px] mx-auto px-4 sm:px-8">
            <div className="max-w-3xl space-y-6">
              ...
              <p className="font-display text-xl text-[var(--color-ink-700)] font-light leading-relaxed">
                The strategic fusion of digital flexibility and deep in-person immersion.
              </p>

              <div className="space-y-4 pt-6 text-sm text-[var(--color-ink-700)] leading-relaxed">
                <p>
                  Designed specifically for busy founders and executive leaders who cannot attend weekly physical lectures, yet seek the invaluable relational trust of in-person retreats.
                </p>
                <p>
                  Participants engage in weekly online seminars and assignments, then gather for two intensive physical weekend retreats over the course of the programme.
                </p>
              </div>

              <div className="pt-6">
                <Link
                  href="/programs?mode=Blended"
